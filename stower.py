...
"""
    ...
    print(f"{RED}   This tool is meant for authorized security testing. {RESET}")
    print(f"{RED}   Unauthorized scanning may be considered a violation of federal law.{RESET}")
    print()
